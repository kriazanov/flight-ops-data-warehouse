"""
**Description**: Retrieving information about ZUT_BILL financial transactions
**Target**: `raw_sap_zut_bill_soap_response`
**Call**: `sf_transform_sap_zut_bill`
"""
import logging
...
URL = "http://hostname.com/url/to/zut_bill"
...
def dwh_sap_zut_bill():
    ...
    def load(body):
        ...
        truncate_query = f'truncate table dwh_staging.raw_sap_zut_bill_soap_response'
        insert_query = f'''
